...
if (strategy.includes('kalshiAuthFetch<Record<string, unknown>>("POST", "/portfolio/orders", payload)')) {
  throw new Error("Jackpot repair refused build: deprecated V1 create-order endpoint remains in ethJackpotService.ts");
}
