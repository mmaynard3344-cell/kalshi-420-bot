...
const outdir = "/tmp/ts-eth420-live-isolation";
const outfile = path.join(outdir, "eth420CandidateLiveIsolation.test.mjs");
await build({
  entryPoints: [path.join(root, "src/lib/eth420CandidateLiveIsolation.test.ts")],
