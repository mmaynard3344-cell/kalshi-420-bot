...
const outdir  = "/tmp/ts-poolreset";
const outfile = path.join(outdir, "tradeStore.dbPoolReset.test.mjs");

const result = await build({
  entryPoints: [path.join(root, "src/lib/tradeStore.dbPoolReset.test.ts")],
  platform:    "node",
  bundle:      true,
  format:      "esm",
  outdir,
