...
const outdir = "/tmp/ts-eth420-strategy";
const outfile = path.join(outdir, "eth420SixStepCandidate.test.mjs");
await build({
  entryPoints: [path.join(root, "src/lib/strategies/eth420SixStepCandidate.test.ts")],
