...
export const ETH_SERVICE_ROLES = [
  "martingale", "jump", "reversal", "downfade_e", "downfade_f", "downfade_g", "downfade_h", "ash_v2_i",
] as const;
...
export function serviceOwnsAshV2(role: EthServiceRole | null): boolean { return role === "ash_v2_i"; }
