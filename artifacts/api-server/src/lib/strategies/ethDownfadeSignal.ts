...
// G no longer belongs to the downfade family. Its former probe/downfade logic
// is retired on the Service G branch; G is owned exclusively by g4060ScalpIndex.
export type EthDownfadeRole = "downfade_e" | "downfade_f";
export type EthDownfadeBand = "p80_p99" | "p90_p99";
...
export function isEthDownfadeRole(role: string | null | undefined): role is EthDownfadeRole {
  return role === "downfade_e" || role === "downfade_f";
}
